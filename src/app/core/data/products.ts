...
const ROWS: Row[] = [
  ...
  ['Allen Solly', 'Women Textured Handheld Bag', 80, 100, 'Bags', ['Orange', 'Black'], ONE, 4.8, 121],
  ['Louis Philippe Sport', 'Polo Collar T-Shirt', 50, 55, 'Men', ['Blue', 'Black'], APPAREL, 4.3, 66],
  ...
  ['YK Disney', 'Girls Pink Moana Printed Dress', 80, 100, 'Kids', ['Red', 'Blue', 'Orange', 'Black', 'Green', 'Yellow'], APPAREL, 5, 121],
  ...
  ['Allen Solly', 'Brown Leather Jacket', 60, 70, 'Winter Wear', ['Orange', 'Black'], APPAREL, 4.5, 63],
  ...
  ['Nike', 'Court Vision Sneakers', 72, 85, 'Men', ['Black', 'Red'], ['M', 'L', 'XL', 'XXL'], 4.8, 168],
  ...
  ['Ray-Ban', 'Round Metal Sunglasses', 110, 135, 'Accessories', ['Black', 'Orange'], ONE, 4.9, 201],
  ['Fastrack', 'Sport Digital Watch', 45, 55, 'Watches', ['Green', 'Black'], ONE, 4.0, 48],
  ['Tommy Hilfiger', 'Reversible Leather Belt', 35, 45, 'Belts', ['Black', 'Orange'], SHOE, 4.4, 52],
  ...
  ['Jack and Jones', 'Hooded Puffer Jacket', 98, 125, 'Winter Wear', ['Black', 'Green'], APPAREL, 4.7, 103],
  ['Superdry', 'Quilted Bomber Jacket', 105, 130, 'Winter Wear', ['Blue', 'Black'], APPAREL_PLUS, 4.5, 76],
  ['Marks and Spencer', 'Merino Wool Scarf', 24, 32, 'Accessories', ['Red', 'Yellow'], ONE, 4.2, 29],
  ...
  ['Daniel Wellington', 'Petite Mesh Watch', 130, 160, 'Watches', ['Yellow', 'Black'], ONE, 4.8, 145],
];
